    ...
    <footer className="bg-[#333232] text-white/90 pt-12 pb-12 mt-12">
      ...
      <div className="site-container grid grid-cols-1 md:grid-cols-4 gap-10 items-start">
        ...
        <div>
          ...
          <p className="text-sm font-light text-white/70">+91 98798 66629</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-light text-white/70">
            ...
            <li><Link href="/founder" className="hover:text-white transition-colors">Founder&apos;s overview</Link></li>
            <li><Link href="/contact" className="hover:text-white transition-colors">Reach us</Link></li>
          </ul>
          
          <div className="flex gap-4 mt-6">
            <a href="#" className="w-8 h-8 flex items-center justify-center rounded border border-white/40 hover:border-white transition-colors">
